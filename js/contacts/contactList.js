...
$(function(){
    ...
    ContactsList.prototype.loadContacts();
});

var ContactsList = function(){};

ContactsList.prototype.loadContacts = function(){
    var binding = Cookies.prototype.GetCookie('binding');
    var id = Common.prototype.GetQueryString("khmcId");
    var temp = $(".addproject").attr("href");
    $(".addproject").attr("href",temp.replace("[customerid]",id));
    var expressions = "khmc = '" + id + "'";
                ...
                if (data.result) {
                    ...
                    if (data.data.length > 0) {
                        ...
                        data.data.forEach(function (value, index) {
                            html += "<div class='pro'>";
                            html += "<a href='/crm/contact/contact.html?id=" + value.id + "'>";
                            ...
                            html += "<div class='industry'>" + value.zhiwu + "</div>";
                            html += "<div class='industry'>" + value.shouji + "</div>";
                            html += "</div>";
